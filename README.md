...
Although most of my experience has been backend and full-stack, frontend web development is becoming my newfound passion. I find collaborating with UI/UX designers and building professional and engaging user interfaces to be fun and rewarding.

## Things I Recently Worked On 🧑🏻‍💻

- Web development [@Virufy](https://gevuong.github.io/minimal-i18n-with-app-router/en), transforming new **Figma** designs into responsive web pages on the marketing site, leveraging **React**, **Next.js**, **Typescript**, and **Tailwind CSS** to ensure seamless user experience across devices.
